    ...
    <div class="py-12 px-6 max-w-7xl mx-auto min-h-screen bg-[#FDFCF9]">
        ...
        <div class="mb-10 group">
            <div class="bg-white border border-slate-100 p-8 rounded-[2.5rem] shadow-xl shadow-slate-500/5 transition-all hover:border-slate-200">
                <form action="{{ url()->current() }}" method="GET" class="flex flex-wrap items-end gap-8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ url()->current() }}" class="bg-slate-100 text-slate-500 font-black uppercase text-[10px] px-6 py-3.5 rounded-2xl hover:bg-slate-200 transition-all flex items-center">
                            Reset
                        </a>
                    </div>
                </form>
