    ...
    <div class="py-12  min-h-screen" x-data="{ 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
                ...
                <button @click="massEnrollModal = true" class="w-full sm:w-auto bg-slate-800 hover:bg-slate-900 text-white px-6 py-2.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95 mr-2">
        ...
        <div x-show="massEnrollModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm" x-cloak>
            <div class="bg-white rounded-[2.5rem] p-8 max-w-2xl w-full shadow-2xl border border-white max-h-[90vh] overflow-y-auto" @click.away="massEnrollModal = false">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Upload Excel or CSV to enroll multiple users</p>
                </div>
                ...
                <div class="bg-slate-50 rounded-2xl p-5 mb-6 border border-slate-200/80">
                    ...
                    <ol class="list-decimal list-inside text-xs text-slate-600 space-y-1 font-medium mb-4">
                        ...
                        <li>Valid roles are: <code class="bg-slate-200 px-1.5 py-0.5 rounded text-slate-800 font-bold">student</code>, <code class="bg-slate-200 px-1.5 py-0.5 rounded text-slate-800 font-bold">personnel</code>, or <code class="bg-slate-200 px-1.5 py-0.5 rounded text-slate-800 font-bold">admin</code>,<code class="bg-slate-200 px-1.5 py-0.5 rounded text-slate-800 font-bold">super-admin</code>.</li>
